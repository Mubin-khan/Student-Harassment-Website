...
<h2>MESSAGE:</h2>
 ...
 <tr>
  ...
  <h >Phone: <th>{{$data->phone}}</th></h3>
                             
  </tr>
  <br>
  <tr>
                              
  <h> Message: <th>{{$data->message}}</th></h3>
   ...
   <li><a href="/de">delete  message<span class="icon icon-arrow-right2"></span></a></li>
