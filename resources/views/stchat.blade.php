...
<div>
 ...
 <h1 style="color:Tomato;">Student advisor conversation</h1>
  ...
  <h style="color:#347C17;">{{$data->name}}: <th>{{$data->message}}</th></h3>
...
<br>
    ...
    <form class="login100-form validate-form" action="{{URL::to('/rifa')}}"  method="post">
          @csrf
  ...
  <h1 style="color:Tomato;">PROCTOR CONVERSATION</h1>
    @foreach ($p as $data)
     <tr>
...
<br>
    ...
    <form class="login100-form validate-form" action="{{URL::to('/rifat')}}"  method="post">
          @csrf
...
<h1 style="color:Tomato;">HCELL CONVERSATION</h1>
    @foreach ($h as $data)
...
<form class="login100-form validate-form" action="{{URL::to('/rifatt')}}"  method="post">
   ...
   <div class="container-login100-form-btn">
        ...
        <li><a href="/st">Home page <span class="icon icon-arrow-right2"></span></a></li>
